      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Real Magic</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Bridging traditional finance with the open economy through secure, regulated tokenization.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#tokenization" className="text-gray-400 hover:text-white transition-colors">Tokenization</a></li>
              <li><a href="#investment" className="text-gray-400 hover:text-white transition-colors">Investment Platform</a></li>
              <li><a href="#advisory" className="text-gray-400 hover:text-white transition-colors">Advisory Services</a></li>
              <li><a href="#institutions" className="text-gray-400 hover:text-white transition-colors">For Institutions</a></li>
              <li><a href="#developers" className="text-gray-400 hover:text-white transition-colors">Developer API</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#support" className="text-gray-400 hover:text-white transition-colors">Support Center</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm">
            © 2024 Real Magic. All rights reserved.
          </div>
